...
def pretend_to_be_SSCFormerTrainer(folder, checkpoints=("model_final_checkpoint.pkl", "model_final_checkpoint.model.pkl")):
    pretend_to_be_other_trainer(folder, "SSCFormerTrainer", checkpoints)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Use this script to change the SSCFormer trainer class of a saved '
