...
from SSCFormer.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(SSCFormer.__path__[0], "training", "network_training"),
                              base_module='SSCFormer.training.network_training'):
    ...
    print("###############################################")
    print("I am running the following SSCFormer: %s" % network)
