...
def main():
    ...
    if network == "3d_cascade_fullres":
        assert issubclass(trainer_class, SSCFormerTrainerCascadeFullRes), "If running 3d_cascade_fullres then your " \
                                                                       "trainer class must be derived from " \
                                                                       "SSCFormerTrainerCascadeFullRes"
    else:
        assert issubclass(trainer_class, SSCFormerTrainer), "network_trainer was found but is not derived from " \
                                                         "SSCFormerTrainer"
