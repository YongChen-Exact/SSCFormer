...
import argparse
from SSCFormer.postprocessing.consolidate_postprocessing import consolidate_folds
...
def main():
    ...
    argparser.add_argument("-tr", type=str, required=False, default=None,
                           help="SSCFormerTrainer class. Default: %s, unless 3d_cascade_fullres "
    ...
    if trainer is None:
        if model == "3d_cascade_fullres":
            trainer = "SSCFormerTrainerV2CascadeFullRes"
        else:
            trainer = "SSCFormerTrainerV2"
