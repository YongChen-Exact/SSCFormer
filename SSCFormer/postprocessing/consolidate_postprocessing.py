...
if __name__ == "__main__":
    ...
    folder = args.f
    # output_folder_base = "G:/CY/CodesOfCy/new/SSCFormer-main/DATASET/SSCFormer_trained_models/SSCFormer/3d_fullres/Task001_ACDC/SSCFormerTrainerV2_SSCFormer_acdc__SSCFormerPlansv2.1"
    # output_folder_gt = "G:/CY/CodesOfCy/new/SSCFormer-main/DATASET/SSCFormer_raw/SSCFormer_raw_data/Task01_ACDC/labelsTs"
    # determine_postprocessing(output_folder_base, output_folder_gt, 'cv_niftis_raw',
