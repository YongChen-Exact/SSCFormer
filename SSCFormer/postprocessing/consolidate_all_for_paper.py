...
def get_commands(configurations, regular_trainer="SSCFormerTrainerV2", cascade_trainer="SSCFormerTrainerV2CascadeFullRes",
    ...
    for task in configurations:
        ...
        for m in models:
            ...
            folder = get_output_folder_name(m, task, trainer, plans, overwrite_training_output_dir="/datasets/datasets_fabian/results/SSCFormer")
