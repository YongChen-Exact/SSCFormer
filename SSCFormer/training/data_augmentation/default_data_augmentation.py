...
from SSCFormer.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from SSCFormer.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'SSCFormer_n_proc_DA' not in os.environ else int(os.environ['SSCFormer_n_proc_DA']),
...
if __name__ == "__main__":
    from SSCFormer.training.dataloading.dataset_loading import DataLoader3D, load_dataset
    from SSCFormer.paths import preprocessing_output_dir
    import os
    import pickle
