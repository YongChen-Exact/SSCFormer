...
import argparse
from SSCFormer.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(SSCFormer.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "SSCFormer.training.network_training")
