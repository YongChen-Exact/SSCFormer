...
import matplotlib
from SSCFormer.postprocessing.connected_components import determine_postprocessing
from SSCFormer.training.data_augmentation.default_data_augmentation import get_default_augmentation
from SSCFormer.training.dataloading.dataset_loading import DataLoader3D, unpack_dataset
from SSCFormer.evaluation.evaluator import aggregate_scores
...
from SSCFormer.inference.segmentation_export import save_segmentation_nifti_from_softmax
from batchgenerators.utilities.file_and_folder_operations import *
import numpy as np
from SSCFormer.utilities.one_hot_encoding import to_one_hot
import shutil

matplotlib.use("agg")


class SSCFormerTrainerCascadeFullRes(SSCFormerTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="SSCFormerTrainer", fp16=False):
        super(SSCFormerTrainerCascadeFullRes, self).__init__(plans_file, fold, output_folder, dataset_directory,
    ...
    def do_split(self):
        super(SSCFormerTrainerCascadeFullRes, self).do_split()
    ...
    def process_plans(self, plans):
        super(SSCFormerTrainerCascadeFullRes, self).process_plans(plans)
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        if run_postprocessing_on_folds:
            # in the old SSCFormer we would stop here. Now we add a postprocessing. This postprocessing can remove everything
