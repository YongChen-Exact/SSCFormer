...
from SSCFormer.training.network_training.SSCFormerTrainerV2 import SSCFormerTrainerV2
...
class SSCFormerTrainerV2CascadeFullRes(SSCFormerTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="SSCFormerTrainerV2", fp16=False):
