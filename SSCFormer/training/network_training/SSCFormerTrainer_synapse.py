...
class SSCFormerTrainer_synapse(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(SSCFormerTrainer_synapse, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(SSCFormerTrainer_synapse, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(SSCFormerTrainer_synapse, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
