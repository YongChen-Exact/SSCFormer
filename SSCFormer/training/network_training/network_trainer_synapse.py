...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        if 'SSCFormer_use_progress_bar' in os.environ.keys():
            self.use_progress_bar = bool(int(os.environ['SSCFormer_use_progress_bar']))
    ...
    def plot_network_architecture(self):
        """
        can be implemented (see SSCFormerTrainer) but does not have to. Not implemented here because it imposes stronger
