...
from SSCFormer.evaluation.metrics import ConfusionMatrix, ALL_METRICS
...
if __name__ == '__main__':
    training_output_folder1 = "G:/CY\CodesOfCy/new/SSCFormer-main/DATASET/SSCFormer_trained_models/SSCFormer/3d_fullres/Task001_ACDC/SSCFormerTrainerV2_SSCFormer_acdc__SSCFormerPlansv2.1"
    plans = load_pickle(join(training_output_folder1, "plans.pkl"))
    output_folder = "G:/CY/CodesOfCy/new/SSCFormer-main/DATASET/SSCFormer_trained_models/SSCFormer/ensembles/Task001_ACDC/ensemble_3d_fullres__SSCFormerTrainerV2_SSCFormer_acdc__SSCFormerPlansv2.1--3d_fullres__SSCFormerTrainerV2_SSCFormer_acdc__SSCFormerPlansv2.1"
    ...
    out_files=[]
    gt_segmentations=[]
    folder_with_gt_segs = "G:/CY/CodesOfCy/new/SSCFormer-main/DATASET/SSCFormer_raw/SSCFormer_raw_data/Task01_ACDC/labelsTr"
