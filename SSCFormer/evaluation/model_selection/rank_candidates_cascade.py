...
if __name__ == "__main__":
    ...
    plans = "SSCFormerPlansv2.1"

    overwrite_plans = {
        'SSCFormerTrainerCascadeFullRes': ['SSCFormerPlans'],
    }

    trainers = [
        'SSCFormerTrainerCascadeFullRes',
        'SSCFormerTrainerV2CascadeFullRes_EducatedGuess',
        'SSCFormerTrainerV2CascadeFullRes_EducatedGuess2',
        'SSCFormerTrainerV2CascadeFullRes_EducatedGuess3',
        'SSCFormerTrainerV2CascadeFullRes_lowerLR',
        'SSCFormerTrainerV2CascadeFullRes',
        'SSCFormerTrainerV2CascadeFullRes_noConnComp',
        'SSCFormerTrainerV2CascadeFullRes_shorter_lowerLR',
        'SSCFormerTrainerV2CascadeFullRes_shorter',
        'SSCFormerTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
