...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'SSCFormerTrainerV2_2': ["SSCFormerPlans", "SSCFormerPlans_customClip"], # r
        'SSCFormerTrainerV2_2_noMirror': ["SSCFormerPlans", "SSCFormerPlans_customClip"],  # r
        'SSCFormerTrainerV2_lessMomentum_noMirror': ["SSCFormerPlans", "SSCFormerPlans_customClip"],  # r
        'SSCFormerTrainerV2_2_structSeg_noMirror': ["SSCFormerPlans", "SSCFormerPlans_customClip"],  # r
        'SSCFormerTrainerV2_2_structSeg': ["SSCFormerPlans", "SSCFormerPlans_customClip"],  # r
        'SSCFormerTrainerV2_lessMomentum_noMirror_structSeg': ["SSCFormerPlans", "SSCFormerPlans_customClip"],  # r
        'SSCFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["SSCFormerPlans", "SSCFormerPlans_customClip"],  # r
        'SSCFormerTrainerV2_FabiansResUNet_structSet_NoMirror': ["SSCFormerPlans", "SSCFormerPlans_customClip"],  # r
        'SSCFormerTrainerV2_FabiansResUNet_structSet': ["SSCFormerPlans", "SSCFormerPlans_customClip"],  # r

    }

    trainers = ['SSCFormerTrainer'] + [
        'SSCFormerTrainerV2_2',
        'SSCFormerTrainerV2_lessMomentum_noMirror',
        'SSCFormerTrainerV2_2_noMirror',
        'SSCFormerTrainerV2_2_structSeg_noMirror',
        'SSCFormerTrainerV2_2_structSeg',
        'SSCFormerTrainerV2_lessMomentum_noMirror_structSeg',
        'SSCFormerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'SSCFormerTrainerV2_FabiansResUNet_structSet_NoMirror',
        'SSCFormerTrainerV2_FabiansResUNet_structSet',
    ]
