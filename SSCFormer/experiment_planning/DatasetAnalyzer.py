...
from SSCFormer.paths import SSCFormer_raw_data, SSCFormer_cropped_data
import numpy as np
import pickle
from SSCFormer.preprocessing.cropping import get_patient_identifiers_from_cropped_files
