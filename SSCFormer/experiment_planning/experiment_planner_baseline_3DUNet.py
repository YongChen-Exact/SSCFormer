...
from SSCFormer.configuration import default_num_threads
from SSCFormer.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from SSCFormer.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from SSCFormer.experiment_planning.utils import create_lists_from_splitted_dataset
from SSCFormer.network_architecture.generic_UNet import Generic_UNet
from SSCFormer.paths import *
from SSCFormer.preprocessing.cropping import get_case_identifier_from_npz
from SSCFormer.training.model_restore import recursive_find_python_class
...
class ExperimentPlanner(object):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "SSCFormerPlans" + "fixed_plans_3D.pkl")
    ...
    def plan_experiment(self):
        ...
        # thanks Zakiyi (https://github.com/MIC-DKFZ/SSCFormer/issues/61) for spotting this bug :-)
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(SSCFormer.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="SSCFormer.preprocessing")
...
if __name__ == "__main__":
    ...
    for i in task_ids:
        i = int(i)
        candidates = subdirs(SSCFormer_cropped_data, prefix="Task%03.0d" % i, join=False)
    ...
    for t in tasks:
        try:
            print("\n\n\n", t)
            cropped_out_dir = os.path.join(SSCFormer_cropped_data, t)
            preprocessing_output_dir_this_task = os.path.join(preprocessing_output_dir, t)
            splitted_4d_output_dir_task = os.path.join(SSCFormer_raw_data, t)
            ...
            shutil.copy(join(SSCFormer_raw_data, t, "dataset.json"), preprocessing_output_dir_this_task)
